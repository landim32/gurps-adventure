...
> Sumário original do livro (GURPS 3ª Edição - Módulo Básico, edição brasileira), reconstituído a partir das páginas 2 a 5 do PDF. Os números à direita de cada item são as páginas impressas do livro (que coincidem com o número da página do PDF, a partir da pág. 2). Itens sem número de página nesta tabela ocupavam apenas uma posição de layout na página original (linha em branco entre seções).

*Nota: PREFÁCIO DA EDIÇÃO BRASILEIRA (pág. III), AGRADECIMENTOS (pág. IV) e SUGESTÕES AOS JOGADORES INICIANTES (pág. V) fazem parte do livro original, mas não estão presentes nesta cópia (substituídas por uma página de agradecimentos da equipe de digitalização — ver [11-quadros-e-tabelas... não aplicável]; conteúdo em `_paginas_fase1/pagina-001.md`).*
...
| &nbsp;&nbsp;Perícias com Armas e Combate | 49 |
...
| &nbsp;&nbsp;Ataques de Surpresa e Iniciativa | 122 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Animais Treinados e de Estimação | 143 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Custo de Fabricação de Objetos Encantados | 152 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;Transferência de Dinheiro entre Mundos | 191 |
...
| &nbsp;&nbsp;Viagens entre Cenários | 200 |
| &nbsp;&nbsp;&nbsp;&nbsp;Elaboração de Cenários | 200 |
| &nbsp;&nbsp;&nbsp;&nbsp;E o Trabalho de Vocês? | 200 |
| **APÊNDICE** *(entre as páginas 200 e 201 — ausente nesta cópia, ver nota abaixo)* | A1-A16 |
| &nbsp;&nbsp;Novas Vantagens | A1 |
...
| &nbsp;&nbsp;Tabela de Golpes Fulminantes | 202 |
...
| **UMA NOITE DE TRABALHO** *(aventura solo)* | 218 |
| **CARAVANA PARA EIN ARRIS** *(aventura)* | 232 |
| **GLOSSÁRIO** | 250 |
...
| &nbsp;&nbsp;Pesos e Medidas | 257 |
| &nbsp;&nbsp;Principais Obras Consultadas | 258 *(fora do escopo desta cópia — PDF termina na pág. 257)* |
| **SUPLEMENTOS GURPS** | 259 *(fora do escopo desta cópia)* |

## Nota sobre o Apêndice ausente

O índice original lista um apêndice de 16 páginas numeradas separadamente (A1 a A16, com Novas Vantagens, Novas Desvantagens, Novas Perícias e Outras Regras), inserido fisicamente "entre as páginas 200 e 201". Ao conferir esta cópia digitalizada, a página do PDF imediatamente após a pág. 200 já é a pág. 201 ("QUADROS E TABELAS") — ou seja, **o apêndice não está presente neste arquivo PDF**. Isso está sinalizado no capítulo [21 - Escrevendo Aventuras](20-escrevendo-aventuras.md) e não pôde ser reconstituído nesta documentação.
